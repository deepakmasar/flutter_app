...
class followingBlog extends StatefulWidget {
  const followingBlog({super.key});

  @override
  State<followingBlog> createState() => _followingBlogState();
}

class _followingBlogState extends State<followingBlog> {
  @override
