...
class profilesBlog extends StatefulWidget {
  const profilesBlog({super.key});

  @override
  State<profilesBlog> createState() => _profilesBlogState();
}

class _profilesBlogState extends State<profilesBlog> {
  @override
