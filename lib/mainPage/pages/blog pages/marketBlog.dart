...
class marketBlog extends StatefulWidget {
  const marketBlog({super.key});

  @override
  State<marketBlog> createState() => _marketBlogState();
}

class _marketBlogState extends State<marketBlog> {
  @override
